...
def signup(request):
    if request.method == "POST":
        ...
        subject = "Welcome to Arise - Django Login!!"
        message = "Hello " + myuser.first_name + "!! \n" + "Welcome to Arise !! \n Thank You For Visiting Our Website \n We have also sent to you a confirmation email, please confirm your email address in order to activate your Account. \n\n Thanking You \n Ayyaz Kanani"
